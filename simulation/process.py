...
class SimulationProcess(object):
    ...
    def set_relationships(self, id_obj_1, id_obj_2):
        if id_obj_1 in self.relationships:
            self.relationships[id_obj_1].add(id_obj_2)
        else:
            self.relationships[id_obj_1] = {id_obj_2}
        if id_obj_2 in self.relationships:
            self.relationships[id_obj_2].add(id_obj_1)
        else:
    ...
    def remove_relationships(self, id_obj_1, id_obj_2):
        if id_obj_1 in self.relationships:
            self.relationships[id_obj_1].discard(id_obj_2)
        if id_obj_2 in self.relationships:
            self.relationships[id_obj_2].discard(id_obj_1)
